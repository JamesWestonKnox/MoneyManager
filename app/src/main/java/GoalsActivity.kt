...
class GoalsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.goals_page)  // Make sure this matches your goals XML

        val btnNewGoal = findViewById<Button>(R.id.btnNewGoal)

        btnNewGoal.setOnClickListener {
            val bottomSheetDialog = BottomSheetDialog(this)
            val sheetView = LayoutInflater.from(this).inflate(R.layout.bottom_sheet_new_goal, null) // Correct layout reference
